...
- If no registration is linked to the account, the API finds a submitted unlinked registration with the same email and links it to the logged-in account before returning it. This supports guest submissions made before signup.
